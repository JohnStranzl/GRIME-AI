...
def NEON_API_Example(self):
    ...
    for product in site_json['data']['dataProducts']:
        ...
        productList += "\n" + product['dataProductCode'] + ": " + product['dataProductTitle']

    QMessageBox.information(self, "Product List", productList)
    ...
    for file in data_json['data']['files']:
        if (('_perpoint' in file['name']) | (
                '_countdata' in file['name'])):  # if file name includes '_perpoint' or '_countdata'
