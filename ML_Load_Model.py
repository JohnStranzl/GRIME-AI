...
class ML_Load_Model:
    def __init__(self, cfg: DictConfig = None):
        ...
        if cfg is None or "load_model" not in cfg:
            ...
            config_file = os.path.join(dirname, "site_config.json")
    ...
    def show_masks(self, image_name, image, mask, scores, point_coords=None, box_coords=None, input_labels=None,
                   borders=True):
        ...
        output_path = os.path.join(f"{self.OUTPUT_DIR}/images", image_name)
    ...
    def ML_Load_Model_Main(self):
        ...
        images_list = [f for f in os.listdir(self.INPUT_DIR) if f.endswith('.jpg')]
        for image in images_list:
            ...
            self.show_masks(image, pil_image, mask, score, borders=True)
